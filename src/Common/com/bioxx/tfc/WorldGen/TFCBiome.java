...
public class TFCBiome extends BiomeGenBase
{
	...
	public static final TFCBiome HELL = new TFCBiomeGenHell(8).setColor(16711680).setBiomeName("Hell").setDisableRain().setTemperatureRainfall(2.0F, 0.0F).setMinMaxHeight(0.8F, 1.6F);
	...
	public static final TFCBiome NOTHER = new TFCBiomeGenHell(9).setColor(16711680).setBiomeName("Nother").setDisableRain().setTemperatureRainfall(2.0F, 0.0F).setMinMaxHeight(0.8F, 1.6F).setBiomeColor(0x1f392b);
